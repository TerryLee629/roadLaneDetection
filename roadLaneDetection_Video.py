...
cap = cv2.VideoCapture('LaneVideo.mp4') #輸入影片LaneVideo 或 LaneVideo_solidWhiteRight
out = cv2.VideoWriter('output.mp4', fourcc, 30, (640, 400)) #輸出框有車道的影片
...
while True:
    ...
    p1, p2, p3, p4 = [r, hh - r], [ww - 50 , hh -r], [xx2-60, yy2+40], [xx1+60, yy2+40] # for_LaneVideo.mp4
    # p1, p2, p3, p4 = [int(ww*0.1), hh - r], [ww - 50 , hh -r], [xx2, yy2-30], [xx1, yy2-30] # for_LaneVideo_solidWhiteRight.mp4
    ...
    lines = cv2.HoughLinesP(output, 1, np.pi / 180, HOUGH_THRESHOLD, None, HOUGH_MIN_LINE_LENGTH, HOUGH_MAX_LINE_GAP)   #霍夫直線檢測
